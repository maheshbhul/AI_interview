...
const Navbar = () => {
    ...
    const[showCreditPopoUp,setShowCreditPopoUp]=useState(false);
  ...
  return (
    ...
    className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
      <div className='w-full max-w-6xl bg-white rounded-[24px] 
            ...
            rounded-full text-md hover:bg-gray-200 transition'>
                ...
                {showCreditPopoUp&&(
                    ...
                    border border-gray-200 rounded p-5 z-50'>
                        ...
                        text-white py-2 rounded-lg text-sm'>Buy more credits</button>
                    </div>
                )}
            </button>
        </div>
    ...
    : <FaUserAstronaut size={16} />
             ...
             {showUserPopUp&&(
                ...
                border-gray-200 rounded-xl p-4 z-50">
                    ...
                    text-sm py-2 flex items-center 
                    gap-2 text-red-500'><HiOutlineLogout size={16}/>Logout</button>
                </div>
             )}
