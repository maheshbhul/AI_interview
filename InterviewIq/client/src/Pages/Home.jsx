...
import hrImg from "../assets/ai-ans.png";
import techImg from "../assets/confi.png";
import confidenceImg from "../assets/credit.png";
import creditImg from "../assets/hero.png";
import evalImg from "../assets/history.png";
import resumeImg from "../assets/HR.png";
import pdfImg from "../assets/img1.png";
import analyticsImg from "../assets/MM.png";
     ...
     <div className='flex justify-center mb-6'>
      ...
      <div className='text-center mb-28'>
        ...
        className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
          Role-based mock interviews with smart follow-ups,Adaptive difficultiy and real-time performance evaluation.
        </motion.p>
